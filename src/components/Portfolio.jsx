  ...
  return (
    <div className="bg-slate-100 min-h-screen p-6">
      <header className="bg-cyan-500 p-4 rounded-md shadow-md mb-6">
        <h1 className="text-4xl font-bold text-white text-center">EDIBILLI GAYATRI</h1>
      ...
      <section className="mb-6">
        ...
        <div className="bg-white p-4 rounded-md shadow-md">
          ...
          <p>Developed a todo List application with user authentication to manage grocery items efficiently.</p>
          <p>Technologies used: React.js, Node.js, Express.js, MongoDB</p>
      ...
      <section>
        ...
        <div className="bg-white p-4 rounded-md shadow-md">
          ...
          <p>Solved 300+ problems on CodeChef, achieving a 2-star rating.</p>
          <p>Solved 100+ problems on LeetCode, with a rating of 1500+.</p>
          <a href="https://www.codechef.com/users/gayatriedibili" className="text-cyan-600">CodeChef Profile</a> | <a href="https://leetcode.com/u/Gayathri_Edibilli/" className="text-cyan-600">LeetCode Profile</a>
        </div>
      </section>
    </div>
  );
